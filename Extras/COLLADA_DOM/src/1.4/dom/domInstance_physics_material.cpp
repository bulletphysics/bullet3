...
domInstance_physics_material::registerElement()
{
	...
	_Meta->setStaticPointerAddress(&domInstance_physics_material::_Meta);
	_Meta->registerConstructor(domInstance_physics_material::create);

	// Add elements: extra
    _Meta->appendArrayElement(domExtra::registerElement(),daeOffsetOf(domInstance_physics_material,elemExtra_array));
