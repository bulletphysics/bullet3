...
#endif
{
	...
	PyModule_AddIntConstant(m, "URDF_IGNORE_VISUAL_SHAPES", URDF_MAINTAIN_LINK_ORDER);
	PyModule_AddIntConstant(m, "URDF_IGNORE_COLLISION_SHAPES", URDF_MAINTAIN_LINK_ORDER);
	PyModule_AddIntConstant(m, "URDF_PRINT_URDF_INFO", URDF_MAINTAIN_LINK_ORDER);
