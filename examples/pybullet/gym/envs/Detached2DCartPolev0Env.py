...
# A pole is standing unattached on top of a cart, which moves along a frictionless track. 
...
#
# DetachedCartPole-v0 defines "solving" as getting average reward of 195.0 over 100 consecutive trials.
#
...
class Detached2DCartPolev0Env(gym.Env):
	...
	def __init__(self, opts):
		...
		self.cart = p.loadURDF("envs/models/cart.urdf", 0,0,0.025, 0,0,0,1)
		self.pole = p.loadURDF("envs/models/pole.urdf", 0,0,0.275, 0,0,0,1)
