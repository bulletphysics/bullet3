...
class Reacher(MujocoXmlBasedRobot):
	TARG_LIMIT = 0.27

	def __init__(self):
		MujocoXmlBasedRobot.__init__(self, 'reacher.xml', 'body0', action_dim=2, obs_dim=9)
...
class Pusher(MujocoXmlBasedRobot):
	...
	def __init__(self):
		MujocoXmlBasedRobot.__init__(self, 'pusher.xml', 'body0', action_dim=7, obs_dim=55)
...
class Striker(MujocoXmlBasedRobot):
...
class Thrower(MujocoXmlBasedRobot):
	min_target_placement_radius = 0.1
	max_target_placement_radius = 0.8
	min_object_placement_radius = 0.1
	max_object_placement_radius = 0.8
	...
	def __init__(self):
		MujocoXmlBasedRobot.__init__(self, 'thrower.xml', 'body0', action_dim=7, obs_dim=48)
