...
agent_register.register(
	id='KerasCEMAgent-v0',
	entry_point='agents_kerasrl:KerasCEMAgent'
)

agent_register.register(
	id='KerasDDPGAgent-v0',
	entry_point='agents_kerasrl:KerasDDPGAgent'
)

agent_register.register(
	id='KerasDDQNAgent-v0',
	entry_point='agents_kerasrl:KerasDDQNAgent'
)

agent_register.register(
	id='KerasDQNAgent-v0',
	entry_point='agents_kerasrl:KerasDQNAgent'
)

agent_register.register(
	id='KerasNAFAgent-v0',
	entry_point='agents_kerasrl:KerasNAFAgent'
)
