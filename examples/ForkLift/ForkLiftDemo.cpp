...
/// raycast vehicle notice that for higher-quality slow-moving vehicles, another
/// approach might be better implementing explicit hinged-wheel constraints with
/// cylinder collision, rather then raycasts
