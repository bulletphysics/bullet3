...
void ComputeTotalNumberOfJoints(const URDFImporterInterface& u2b,
  ...
  // u2b.getLinkName(linkIndex).c_str(),childIndices.size()); for (int
  // i=0;i<childIndices.size();i++)
  //{
...
void ConvertURDF2BulletInternal(const URDFImporterInterface& u2b,
  ...
  if (urdfParentIndex == -2) {
    ...
    u2b.getMassAndInertia(urdfParentIndex, parentMass,
  ...
  for (int i = 0; i < numChildren; i++) {
    ...
    ConvertURDF2BulletInternal(u2b, creation, cache, urdfChildLinkIndex,
                               linkTransformInWorldSpace, world1,
                               createMultiBody, pathPrefix, flags);
  }
}
void ConvertURDF2Bullet(const URDFImporterInterface& u2b,
  ...
  ConvertURDF2BulletInternal(u2b, creation, cache, urdfLinkIndex,
                             rootTransformInWorldSpace, world1, createMultiBody,
                             pathPrefix, flags);
