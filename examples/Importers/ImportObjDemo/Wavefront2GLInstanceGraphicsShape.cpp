...
GLInstanceGraphicsShape* btgCreateGraphicsShapeFromWavefrontObj(
    std::vector<tinyobj::shape_t>& shapes, bool flatShading) {
        ...
        if (1) {
          ...
          if (shape.mesh.texcoords.size()) {
            ...
            if (uv0Index >= 0 && uv1Index >= 0 &&
                (uv0Index < int(shape.mesh.texcoords.size()) &&
                 (uv1Index < shape.mesh.texcoords.size()))) {
          ...
          if (shape.mesh.texcoords.size()) {
            ...
            if (uv0Index >= 0 && uv1Index >= 0 &&
                (uv0Index < shape.mesh.texcoords.size()) &&
                (uv1Index < shape.mesh.texcoords.size())) {
          ...
          bool hasNormals = (shape.mesh.normals.size() &&
          ...
          if (flatShading || !hasNormals) {
            ...
            vtx0.normal[2] =
                shape.mesh.normals[shape.mesh.indices[f] * 3 +
                                   2];  // shape.mesh.indices[f+1]*3+0
            vtx1.normal[0] =
                shape.mesh.normals[shape.mesh.indices[f + 1] * 3 + 0];
            vtx1.normal[1] =
                shape.mesh.normals[shape.mesh.indices[f + 1] * 3 + 1];
            vtx1.normal[2] =
                shape.mesh.normals[shape.mesh.indices[f + 1] * 3 + 2];
            vtx2.normal[0] =
                shape.mesh.normals[shape.mesh.indices[f + 2] * 3 + 0];
            vtx2.normal[1] =
                shape.mesh.normals[shape.mesh.indices[f + 2] * 3 + 1];
            vtx2.normal[2] =
                shape.mesh.normals[shape.mesh.indices[f + 2] * 3 + 2];
          }
