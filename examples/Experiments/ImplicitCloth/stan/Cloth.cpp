...
// backward integration in order to implement a cloth system within a 3D game
// environment. The cloth class extends the springnetwork class in order to
// provide import/export, rendering support, and hooks into the game.
//
...
&color_rgb); Line(X[s.a],X[s.b],color[s.type]);
       }
}
*/
