...
void RealTimeBullet3CollisionSdk::deleteShape(
  ...
  // user indices this would be solved by one more in-direction, at some
  // performance penalty for certain operations for now, we don't delete and
  // eventually run out-of-shapes
}
