...
/// pieces) The btFractureBody is a class derived from btRigidBody, dealing with
/// the collision impacts. Press the F key to toggle between fracture and glue
/// mode This is preliminary work
