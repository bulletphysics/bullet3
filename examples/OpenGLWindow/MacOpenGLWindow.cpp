...
float MacOpenGLWindow::getTimeInSeconds() { return 0.f; }
...
void MacOpenGLWindow::startRendering() { Mac_updateWindow(m_internalData); }

void MacOpenGLWindow::endRendering() { Mac_swapBuffer(m_internalData); }

bool MacOpenGLWindow::requestedExit() const {
  return Mac_requestedExit(m_internalData);
}

void MacOpenGLWindow::setRequestExit() { Mac_setRequestExit(m_internalData); }
...
int MacOpenGLWindow::getWidth() const { return Mac_getWidth(m_internalData); }

int MacOpenGLWindow::getHeight() const { return Mac_getHeight(m_internalData); }
...
void MacOpenGLWindow::setMouseButtonCallback(
