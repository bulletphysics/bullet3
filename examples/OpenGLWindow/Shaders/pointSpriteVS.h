...
static const char* pointSpriteVertexShader =
    ...
    "	vec4 vertexPos = ProjectionMatrix * ModelViewMatrix "
    "*(instance_position);\n"
    "	vec3 posEye = vec3(ModelViewMatrix * vec4(instance_position.xyz, "
    "1.0));\n"
    "   float dist = length(posEye);\n"
    "	float pointRadius = 1.f;\n"
    "    gl_PointSize = instance_scale.x * pointRadius * (screenWidth / "
    "dist);\n"
