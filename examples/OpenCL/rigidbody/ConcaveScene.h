...
class ConcaveScene : public GpuRigidBodyDemo {
 public:
  ...
  virtual const char* getName() { return "BoxTrimesh"; }
  ...
  virtual void createConcaveMesh(const ConstructionInfo& ci,
                                 const char* fileName, const b3Vector3& shift,
...
class ConcaveSphereScene : public ConcaveScene {
 public:
  ...
  virtual const char* getName() { return "SphereTrimesh"; }
...
class ConcaveCompoundScene : public ConcaveScene {
 public:
  ...
  virtual const char* getName() { return "CompoundConcave"; }
...
class ConcaveCompound2Scene : public ConcaveCompoundScene {
 public:
  ...
  virtual const char* getName() { return "GRBConcave2Compound"; }
