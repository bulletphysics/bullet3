...
#define P2P
    ...
    // friction float	targetVelocity = 0.f; float	maxMotorImpulse = 0.01;
  ...
  {  // create a door using hinge constraint attached to the world
    ...
    //0.0f); 		spDoorHinge->setLimit( -SIMD_PI*0.8f, SIMD_PI, 0.9f, 0.01f, 0.0f);
    //// "sticky limits"
  ...
  {  // create a generic 6DOF constraint
    ...
    //= 5.0f; 		pGen6DOF->getTranslationalLimitMotor()->m_maxMotorForce[0] = 0.1f;

    //		pGen6DOF->setAngularLowerLimit(btVector3(0., SIMD_HALF_PI*0.9,
    //0.)); 		pGen6DOF->setAngularUpperLimit(btVector3(0., -SIMD_HALF_PI*0.9,
    //0.)); 		pGen6DOF->setAngularLowerLimit(btVector3(0., 0., -SIMD_HALF_PI));
    ...
    //0.8f)); 		pGen6DOF->setAngularUpperLimit(btVector3(0.f, 0.75, -SIMD_HALF_PI
    //* 0.8f)); 		pGen6DOF->setAngularLowerLimit(btVector3(0.f, -SIMD_HALF_PI *
    //0.8f, SIMD_HALF_PI * 1.98f));
  ...
  {  // create a ConeTwist constraint
    ...
    //btScalar(SIMD_PI) * 0.8f); 		m_ctc->setLimit(btScalar(SIMD_PI_4*0.6f),
    //btScalar(SIMD_PI_4), btScalar(SIMD_PI) * 0.8f, 1.0f); // soft limit ==
    //hard limit
