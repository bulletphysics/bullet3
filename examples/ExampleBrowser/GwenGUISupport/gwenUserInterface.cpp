...
void GwenUserInterface::init(int width, int height,
  ...
  Gwen::Controls::GroupBox(m_data->pCanvas); box->SetText("text");
  box->SetName("name");
  box->SetHeight(500);
  */
  ...
  Gwen::Controls::WindowControl(m_data->pCanvas); windowBottom->SetHeight(100);
  ...
  */
  ...
  Gwen::Controls::SplitterBar(m_data->pCanvas); split->Dock(Gwen::Pos::Center);
  split->SetHeight(300);
  split->SetWidth(300);
  */
  /*
