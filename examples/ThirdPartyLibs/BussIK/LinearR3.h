...
// Project u onto v inline VectorR3 ProjectPerpUnit ( const VectorR3& u, const
// VectorR3 & v); // Project perp to v inline VectorR3 ProjectPerpUnitDiff (
...
//u,v. 		If u, v are orthonormal, this is a projection with scaling. 		If they are
//not orthonormal, the results are more difficult 		to interpret.
inline LinearMapR3 PlaneProjectMap(const VectorR3& u, const VectorR3& v) {
