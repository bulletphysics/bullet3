...
// found. Algorithm uses row operations and row pivoting (only). Augmented
// matrix is correctly accomodated.  Only the first square part participates
...
//handles 		sorting the eigenvalues by magnitude.)
// ********************************************************************************************
...
// ************************************************ CalcBidiagonal
// ************************** Helper routine for SVD computation U is a matrix
// to be bidiagonalized. On return, U and V are orthonormal and w holds the new
// diagonal
...
//later 			and has one more implied leading zero 	 basePt = beginning of the first
//Householder transform 	 colStride, rowStride: Householder xforms are stored in
//"columns"
...
// *********************************************** Do the iterative
// transformation from bidiagonal form to diagonal form using
...
// non-zero entry across the row; when it reaches the last
...
// the non-zero entry up the column; when it reaches the last
//	column, it is finally zeroed away.
// wPtr points to the zero entry on the diagonal.  sdPtr points to the non-zero
