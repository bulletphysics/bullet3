#ifndef __glad_glx_h_
#define __glad_glx_h_
...
GLAPI int gladLoadGLX(Display *display, int screen, GLADloadproc load, void *userptr);
GLAPI int gladLoadGLXSimple(Display *display, int screen, GLADsimpleloadproc load);
