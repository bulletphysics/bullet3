...
public:
	...
	virtual void Run(float delta) { m_Control->SetHeight(int((float)m_iStartSize + (((float)m_iDelta) * delta))); }
	virtual void OnFinish()
	{
...
public:
	...
	virtual void Run(float delta) { m_Control->SetWidth(int((float)m_iStartSize + (((float)m_iDelta) * delta))); }
	virtual void OnFinish()
	{
