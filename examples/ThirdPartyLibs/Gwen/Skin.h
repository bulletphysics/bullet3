...
class GWEN_EXPORT Base {
 public:
  ...
  virtual ~Base() { ReleaseFont(&m_DefaultFont); }
  ...
  virtual void DrawRadioButton(Controls::Base* control, bool bSelected,
                               bool bDepressed) = 0;
  virtual void DrawCheckBox(Controls::Base* control, bool bSelected,
                            bool bDepressed) = 0;
  virtual void DrawGroupBox(Controls::Base* control, int textStart,
                            int textHeight, int textWidth) = 0;
  virtual void DrawTextBox(Controls::Base* control) = 0;
  virtual void DrawWindow(Controls::Base* control, int topHeight,
                          bool inFocus) = 0;
  ...
  virtual void DrawScrollBarBar(Controls::Base* control, bool bDepressed,
                                bool isHovered, bool isHorizontal) = 0;
  virtual void DrawScrollBar(Controls::Base* control, bool isHorizontal,
                             bool bDepressed) = 0;
  virtual void DrawScrollButton(Controls::Base* control, int iDirection,
                                bool bDepressed) = 0;
  ...
  virtual void DrawSlider(Controls::Base* control, bool bIsHorizontal,
                          int numNotches, int barSize) = 0;
  virtual void DrawComboBox(Controls::Base* control) = 0;
  virtual void DrawComboBoxButton(Controls::Base* control, bool bDepressed) = 0;
  virtual void DrawKeyboardHighlight(Controls::Base* control,
                                     const Gwen::Rect& rect, int offset) = 0;
  ...
  virtual void DrawTreeNode(Controls::Base* ctrl, bool bOpen, bool bSelected,
                            ...
                            int iLastBranch, bool bIsRoot) = 0;
  ...
  virtual Gwen::Renderer::Base* GetRender() { return m_Render; }
 ...
 public:
  virtual Gwen::Font* GetDefaultFont() { return &m_DefaultFont; }

  virtual void SetDefaultFont(const Gwen::UnicodeString& strFacename,
                              float fSize = 10.0f) {
