...
class GWEN_EXPORT Base : public Event::Handler {
 public:
  ...
  virtual const class Layout::TableRow* DynamicCastLayoutTableRow() const {
    return 0;
  }
  ...
  virtual class ::Gwen::ControlsInternal::Resizer* DynamicCastResizer() {
    return 0;
  }
  virtual const class ::Gwen::ControlsInternal::Resizer* DynamicCastResizer()
      const {
    return 0;
  }

  virtual class ::Gwen::ControlsInternal::ColorDisplay*
  DynamicCastColorDisplay() {
    return 0;
  }
  virtual const class ::Gwen::ControlsInternal::ColorDisplay*
  DynamicCastColorDisplay() const {
    return 0;
  }
 ...
 public:
  ...
  virtual void DoCacheRender(Gwen::Skin::Base* skin,
 ...
 public:
  virtual void SetHidden(bool hidden) {
    if (m_bHidden == hidden) return;
    m_bHidden = hidden;
    Invalidate();
  }
  virtual bool Hidden() const;  // Returns true only if this control is hidden
  virtual bool Visible()
      const;  // Returns false if this control or its parents are hidden
 ...
 public:
  ...
  template <typename T>
  void AddAccelerator(Gwen::UnicodeString accelerator, T func,
 ...
 public:
  ...
  virtual void DragAndDrop_SetPackage(bool bDraggable,
  ...
  virtual void DragAndDrop_EndDragging(bool /*bSuccess*/, int /*x*/,
                                       int /*y*/){};
 ...
 public:
  ...
  virtual void DragAndDrop_HoverEnter(Gwen::DragAndDrop::Package* /*pPackage*/,
                                      int /*x*/, int /*y*/) {}
  virtual void DragAndDrop_HoverLeave(
      Gwen::DragAndDrop::Package* /*pPackage*/) {}
  virtual void DragAndDrop_Hover(Gwen::DragAndDrop::Package* /*pPackage*/,
                                 int /*x*/, int /*y*/){};
  virtual bool DragAndDrop_HandleDrop(Gwen::DragAndDrop::Package* pPackage,
                                      int x, int y);
  virtual bool DragAndDrop_CanAcceptPackage(
      Gwen::DragAndDrop::Package* /*pPackage*/) {
    return false;
  }
 ...
 public:
  ...
  virtual void Anim_WidthIn(float fLength, float fDelay = 0.0f,
                            float fEase = 1.0f);
  virtual void Anim_HeightIn(float fLength, float fDelay = 0.0f,
                             float fEase = 1.0f);
  virtual void Anim_WidthOut(float fLength, bool bHide = true,
                             float fDelay = 0.0f, float fEase = 1.0f);
  virtual void Anim_HeightOut(float fLength, bool bHide = true,
                              float fDelay = 0.0f, float fEase = 1.0f);
