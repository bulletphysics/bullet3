...
// Usage:
//
// Gwen::Dialogs::FileOpen( true, "Open Map", "C:\my\folder\", "My Map
// Format|*.bmf", this, &MyClass::OpenFilename );
//
...
//
void GWEN_EXPORT
FileOpenEx(bool bUseSystem, const String& Name, const String& StartPath,
           const String& Extension, Gwen::Event::Handler* pHandler = NULL,
           Gwen::Event::Handler::FunctionStr fnCallback = NULL);

//
// Templated function simply to avoid having to manually cast the callback
// function.
//
template <typename A>
void FileOpen(bool bUseSystem, const String& Name, const String& StartPath,
  ...
  FileOpenEx(bUseSystem, Name, StartPath, Extension, pHandler,
             (Gwen::Event::Handler::FunctionStr)fnCallback);
}
