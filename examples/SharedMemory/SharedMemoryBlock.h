...
struct SharedMemoryBlock {
  ...
  // m_bulletStreamDataClientToServer is a way for the client to create
  // collision shapes, rigid bodies and constraints the Bullet data structures
  // are more general purpose than the capabilities of a URDF file.
  ...
  // to client, for example to provide all details of a multibody including
  // joint/link names, after loading a URDF file.
