...
B3_SHARED_API b3PhysicsClientHandle b3ConnectPhysicsUDP(const char* hostName,
                                                        int port) {
  UdpNetworkedPhysicsProcessor* udp =
      new UdpNetworkedPhysicsProcessor(hostName, port);
