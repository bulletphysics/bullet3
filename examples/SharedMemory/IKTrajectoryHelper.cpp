...
// to joint space positions at each real-time (simulation) step
...
bool IKTrajectoryHelper::computeNullspaceVel(int numQ, const double* q_current,
  ...
  // choose to balance the null space task and the IK target task. Can also
  // adaptively adjust the coefficients based on the residual of the null space
  // velocity in the IK target task space.
