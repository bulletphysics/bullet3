...
void PhysicsLoopBack::getCachedCameraArrayImage(struct b3CameraArrayImageData* cameraData)
{
        return m_data->m_physicsClient->getCachedCameraArrayImage(cameraData);
}
