...
sources2.extend(rglob('examples/pybullet/**/*.c'))

sources2.extend(rglob('src/Bullet3Common/**/*.cpp'))
sources2.extend(rglob('src/BulletCollision/**/*.cpp'))
sources2.extend(rglob('src/BulletDynamics/**/*.cpp'))
sources2.extend(rglob('src/BulletInverseDynamics/**/*.cpp'))
sources2.extend(rglob('src/BulletSoftBody/**/*.cpp'))
sources2.extend(rglob('src/LinearMath/**/*.cpp'))

sources2.extend(rglob('Extras/InverseDynamics/**/*.cpp'))
sources2.extend(rglob('Extras/Serialize/BulletFileLoader/**/*.cpp'))
sources2.extend(rglob('Extras/Serialize/BulletWorldImporter/**/*.cpp'))

sources2.extend(rglob('examples/ThirdPartyLibs/BussIK/**/*.cpp'))
sources2.extend(rglob('examples/ThirdPartyLibs/clsocket/**/*.cpp'))
sources2.extend(rglob('examples/ThirdPartyLibs/Gwen/**/*.cpp'))
sources2.extend(rglob('examples/ThirdPartyLibs/stb_image/**/*.cpp'))
sources2.extend(rglob('examples/ThirdPartyLibs/tinyxml/**/*.cpp'))

sources2.extend(rglob('examples/ThirdPartyLibs/enet/**/*.c', exclude = {'unix.c', 'win32.c'}))
sources2.extend(rglob('examples/ThirdPartyLibs/Wavefront/**/*.cpp', exclude = {'main.cpp'}))

sources2.extend(rglob('examples/Utils/**/*.cpp'))

sources2.extend(rglob('examples/TinyRenderer/**/*.cpp', exclude = {'main.cpp'}))
sources2.extend(rglob('examples/MultiThreading/**/*.cpp', exclude = {'main.cpp', 'MultiThreadingExample.cpp'}))
sources2.extend(rglob('examples/ExampleBrowser/**/*.cpp', exclude = {'main.cpp', 'ExampleEntries.cpp'}))

sources2.extend(rglob('examples/Importers/**/*.cpp', exclude = {
	'BspConverter.cpp',
	'BspLoader.cpp',
...
sources2.extend(rglob('examples/SharedMemory/**/*.cpp', exclude = {
	'main.cpp',
...
sources2.extend(rglob('examples/OpenGLWindow/**/*.cpp', exclude = {
	'EGLOpenGLWindow.cpp',
	'MacOpenGLWindow.cpp',
...
sources2 = [os.path.normpath(x) for x in sources2]

print(len(sources), len(sources2))
print()
print(*sorted(set(sources) - set(sources2)), sep = '\n')
print()
print(*sorted(set(sources2) - set(sources)), sep = '\n')
