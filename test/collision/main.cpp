...
/// functions See btComputeGjkEpaSphereSphereCollision below for an example Todo:
/// the test needs proper coverage and using a convex hull point cloud Also the
/// GJK, EPA and MPR should be improved, both quality and performance
