...
static btScalar v3triple_ref(const btVector3& v, const btVector3& v1,
                             const btVector3& v2);
...
static btScalar v3triple_ref(const btVector3& v, const btVector3& v1,
                             const btVector3& v2) {
  return v.m_floats[0] * (v1.m_floats[1] * v2.m_floats[2] -
                          v1.m_floats[2] * v2.m_floats[1]) +
         v.m_floats[1] * (v1.m_floats[2] * v2.m_floats[0] -
                          v1.m_floats[0] * v2.m_floats[2]) +
         v.m_floats[2] * (v1.m_floats[0] * v2.m_floats[1] -
