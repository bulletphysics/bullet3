...
static inline btVector3& v3interp_ref(btVector3& vr, btVector3& v0,
                                      btVector3& v1, btScalar& rt);
...
int Test_v3interp(void) {
  ...
  for (rt = 0.0f; rt <= 1.0f; rt += 0.1f) {
    ...
    // test self-referencing vector, see issue
    // https://github.com/bulletphysics/bullet3/pull/313
    test_res = v1;
    ...
    if (fabs(correct_res.m_floats[0] - test_res.m_floats[0]) +
      ...
      vlog(
          ...
          "\n rt=%10.4f",
          correct_res.m_floats[0], correct_res.m_floats[1],
          correct_res.m_floats[2], test_res.m_floats[0], test_res.m_floats[1],
          test_res.m_floats[2], rt);
...
static btVector3& v3interp_ref(btVector3& vr, btVector3& v0, btVector3& v1,
                               btScalar& rt) {
