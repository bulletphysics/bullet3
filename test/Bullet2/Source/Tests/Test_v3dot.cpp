...
static inline btScalar v3dot_ref(const btVector3& v1, const btVector3& v2);
...
static btScalar v3dot_ref(const btVector3& v1, const btVector3& v2) {
  return (v1.m_floats[0] * v2.m_floats[0] + v1.m_floats[1] * v2.m_floats[1] +
