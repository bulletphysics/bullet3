 ...
 *Technical Report (http://www.cs.virginia.edu/~dgm4d/papers/RadixSortTR.pdf):
 *
 ...
 *Science", address = "Charlottesville, VA, USA", number = "CS2010-03"
 *		}
 *
...
/// vendor that matches the SDK vendor used to build the application. Preferred
/// device/platform take priority over this platform-vendor match
 ...
 * the given number of iterations, displaying runtime information.
 *
