...
Linear limits, use b3Generic6DofConstraint.setLinearUpperLimit,
...
b3Generic6DofConstraint.getTranslationalLimitMotor method. At this moment
...
b3Generic6DofConstraint.getLimitMotor method, This brings support for limit
...
b3Generic6DofConstraint : public b3TypedConstraint {
  ...
  */
  ...
  /*!
      \pre b3Generic6DofConstraint::calculateTransforms() must be called
     previously.
      */
