...
/// b3Generic6DofConstraint between two rigidbodies each with a pivotpoint that describes the axis location in local space
/*!
...
protected:
	...
	b3Vector3 m_AnchorPos;  // point between pivots of bodies A and B to solve linear axes
