...
b3BroadphasePair* b3HashedOverlappingPairCache::findPair(int proxy0,
  ...
  while (index != B3_NULL_PAIR && equalsPair(m_overlappingPairArray[index],
...
/// query, or use a different solution. It is mainly used for Removing
/// overlapping pairs. Removal could be delayed. we could keep a linked list in
/// each proxy, and store pair in one of the proxies (with lowest memory address)
