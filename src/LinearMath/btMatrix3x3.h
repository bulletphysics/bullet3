...
ATTRIBUTE_ALIGNED16(class) btMatrix3x3 {
  ...
  */
  ...
  /// deformations" See http://dl.acm.org/citation.cfm?doid=2994258.2994269
   ...
   * @param maxIter The iteration stops when we hit the given tolerance or when
   * maxIter have been executed.
   */
  void diagonalize(btMatrix3x3 & rot, btScalar tolerance = 1.0e-9,
                   int maxIter = 100) {
    btQuaternion r;
...
btMatrix3x3& m2) { return btMatrix3x3( m1[0][0] * m2[0][0] + m1[1][0] * m2[1][0]
