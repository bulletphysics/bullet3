...
class btMLCPSolver : public btSequentialImpulseConstraintSolver {
 protected:
  ...
  /// prior to each use. They are only cached here to avoid extra memory
  /// allocations and deallocations and to ensure that multiple instances of the
  /// solver can be run in parallel.
