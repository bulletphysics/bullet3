...
// original author (Kilian Grundl) Math library was replaced from fmatvec to a
// the file src/LinearMath/btMatrixX.h STL/std::vector replaced by
...
class btLemkeAlgorithm {
 public:
  ...
  /**
   * \brief solve algorithm adapted from : Fast Implementation of Lemke’s
   * Algorithm for Rigid Body Contact Simulation (John E. Lloyd)
   */
