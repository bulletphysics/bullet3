...
protected:
	...
	btInternalTickCallback m_internalPostDiscreteCollisionDetectionTickCallback;
...
public:
	...
	void setInternalTickCallback(btInternalTickCallback cb, void* worldUserInfo = 0, bool isPreTick = false, bool isPostCDTick = false)
	{
		if (isPreTick)
		{
			m_internalPreTickCallback = cb;
		}
		else if (isPostCDTick)
		{
			m_internalPostDiscreteCollisionDetectionTickCallback = cb;
		}
		else
		{
