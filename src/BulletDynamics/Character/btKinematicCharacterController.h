...
/// in a world. It uses a ghost object and convex sweep test to test for upcoming
/// collisions. This is combined with discrete collision detection to recover
/// from penetrations. Interaction between btKinematicCharacterController and
/// dynamic rigid bodies needs to be explicity implemented by the user.
...
btKinematicCharacterController : public btCharacterControllerInterface {
 ...
 public:
  ...
  /// up. The slope angle is measured in radians.
