...
/// do not change those serialization structures, it requires an updated
/// sBulletDNAstr/sBulletDNAstr64 this structure is not used, except for loading
/// pre-2.82 .bullet files do not change those serialization structures, it
/// requires an updated sBulletDNAstr/sBulletDNAstr64
