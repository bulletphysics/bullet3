...
class btMultiBodyLinkCollider : public btCollisionObject {
 ...
 public:
  ...
  btMultiBodyLinkCollider(btMultiBody* multiBody, int link)
    ...
    // doesn't merge islands this means that some constraints might point to
    // bodies that are not in the islands, causing crashes if (link>=0 ||
    // (multiBody && !multiBody->hasFixedBase()))
