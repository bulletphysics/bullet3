...
/// query. Contact lists must be create by calling \ref GIM_CREATE_CONTACT_LIST
/// After querys, contact lists must be destroy by calling \ref
/// GIM_DYNARRAY_DESTROY Contacts can be merge for avoid duplicate results by
/// calling \ref gim_merge_contacts
class GIM_CONTACT {
 public:
  btVector3 m_point;
  btVector3 m_normal;
