...
Similar to SIMPLE_GET_UINTKEY \param copy_elements_macro Macro for copy
elements, similar to SIMPLE_COPY_ELEMENTS
*/
...
be the further position after the last element. \param _array \param _start_i
the beginning of the array \param _end_i the ending  index of the array \param
_search_key Value to find \param _comp_macro macro for comparing elements \param
_found If true the value has found. Boolean \param _result_index the index of
the found element, or if not found then it will get the index of the  closest
bigger value
*/
...
be the further position after the last element. \param _array \param _start_i
the beginning of the array \param _end_i the ending  index of the array \param
_search_key Value to find \param _result_index the index of the found element,
or if not found then it will get the index of the  closest bigger value \return
