...
btAxisSweep3::btAxisSweep3(const btVector3& worldAabbMin,
    ...
    : btAxisSweep3Internal<unsigned short int>(
          worldAabbMin, worldAabbMax, 0xfffe, 0xffff, maxHandles, pairCache,
...
bt32BitAxisSweep3::bt32BitAxisSweep3(const btVector3& worldAabbMin,
                                     ...
                                     btOverlappingPairCache* pairCache,
                                     bool disableRaycastAccelerator)
    : btAxisSweep3Internal<unsigned int>(worldAabbMin, worldAabbMax, 0xfffffffe,
                                         0x7fffffff, maxHandles, pairCache,
                                         disableRaycastAccelerator) {
  // 1 handle is reserved as sentinel
