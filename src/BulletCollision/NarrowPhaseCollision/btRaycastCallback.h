 ...
 public:
  ...
  enum EFlags {
    ...
    kF_KeepUnflippedNormal =
        1 << 1,  // Prevents returned face normal getting flipped when a ray
                 // hits a back-facing triangle
                 /// SubSimplexConvexCastRaytest is the default, even if kF_None
                 /// is set.
    kF_UseSubSimplexConvexCastRaytest =
        1 << 2,  // Uses an approximate but faster ray versus convex
