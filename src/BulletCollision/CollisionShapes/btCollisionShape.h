...
/// The btCollisionShape class provides an interface for collision shapes that
/// can be shared among btCollisionObjects.
ATTRIBUTE_ALIGNED16(class) btCollisionShape {
 ...
 public:
  ...
  /// setAnisotropicFriction See Bullet/Demos/RollingFrictionDemo for an example
