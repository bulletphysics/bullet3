...
/// The btBox2dShape is a box primitive around the origin, its sides axis
/// aligned with length specified by half extents, in local shape coordinates.
/// When used as part of a btCollisionObject or btRigidBody it will be an
