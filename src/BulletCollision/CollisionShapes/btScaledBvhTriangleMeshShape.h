...
/// existing btBvhTriangleMeshShape. Note that each btBvhTriangleMeshShape still
/// can have its own local scaling, independent from this
/// btScaledBvhTriangleMeshShape 'localScaling'
