...
class btTriangleMesh : public btTriangleIndexVertexArray {
 ...
 public:
  ...
  /// search is very slow for large triangle meshes. In general it is better to
  /// directly use btTriangleIndexVertexArray instead.
  ...
  /// within the vertices array, so add the vertices first (and to be sure, avoid
