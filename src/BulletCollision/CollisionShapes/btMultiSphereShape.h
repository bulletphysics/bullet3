...
/// spheres. You can create special capsules or other smooth volumes. It is
/// possible to animate the spheres for deformation, but call 'recalcLocalAabb'
/// after changing any sphere position/radius
