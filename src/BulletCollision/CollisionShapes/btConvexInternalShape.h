...
/// shape implementations. The btConvexInternalShape uses a default collision
/// margin set to CONVEX_DISTANCE_MARGIN. This collision margin used by Gjk and
/// some other algorithms, see also btCollisionMargin.h Note that when creating
/// small shapes (derived from btConvexInternalShape), you need to make sure to
/// set a smaller collision margin, using the 'setMargin' API There is a
/// automatic mechanism 'setSafeMargin' used by btBoxShape and btCylinderShape
ATTRIBUTE_ALIGNED16(class) btConvexInternalShape : public btConvexShape {
 ...
 public:
  ...
  /// recommended, it is best to remove the body from the world, then make the
  /// change, and re-add it alternatively flush the contact points, see
