...
/// btConvexShape in a memory efficient way. Istead of using
/// btUniformScalingShape, it is better to use the non-uniform setLocalScaling
/// method on convex shapes that implement it.
