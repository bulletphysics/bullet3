...
inline b3Vector3 localGetSupportVertexWithMargin(
    const float4& supportVec, const struct b3ConvexPolyhedronData* hull,
  ...
  if (0 < hull->m_numVertices) {
    ...
    int index = (int)scaled.maxDot(&verticesA[hull->m_vertexOffset],
...
inline b3Vector3 localGetSupportVertexWithoutMargin(
    const float4& supportVec, const struct b3ConvexPolyhedronData* hull,
