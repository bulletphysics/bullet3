...
struct GpuSatCollision {
  ...
  void computeConvexConvexContactsGPUSAT(
      ...
      const b3OpenCLArray<b3GpuFace>& faces, const b3OpenCLArray<int>& indices,
      ...
      b3OpenCLArray<b3BvhInfo>* bvhInfo, int numObjects,
      int maxTriConvexPairCapacity, b3OpenCLArray<b3Int4>& triangleConvexPairs,
