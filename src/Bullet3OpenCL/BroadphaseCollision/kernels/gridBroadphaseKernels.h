...
static const char* gridBroadphaseCL =
    ...
    "	int hash = gridPos.z * gridDim.y * gridDim.x + gridPos.y * gridDim.x + "
    "gridPos.x;\n"
    "	return hash;\n"
    "} \n"
    ...
    "__kernel void kCalcHashAABB(int numObjects, __global float4* allpAABB, "
    "__global const int* smallAabbMapping, __global int2* pHash, __global "
    "float4* pParams )\n"
    "{\n"
    ...
    "        //if (unsorted_indx2 < unsorted_indx) // check not colliding with "
    "self\n"
