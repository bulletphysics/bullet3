...
static const char* batchingKernelsCL =
    ...
    "		__global const u32* gN, __global const u32* gStart, __global "
    "int* batchSizes, \n"
    "		int m_staticIdx )\n"
    "{\n"
    ...
    "							if (!aStatic)\n"
    "								aAvailable = "
    "tryWrite( ldsCheckBuffer, ea );\n"
    "							if (!bStatic)\n"
    "								bAvailable = "
    "tryWrite( ldsCheckBuffer, eb );\n"
    "							\n"
    "							//aAvailable = "
    ...
    "							gConstraintsOut[ "
    "dstIdx ].m_batchIdx = ie;\n"
    "						}\n"
    "						if( lIdx == 0 ) ldsStackEnd = "
    "0;\n"
    "						//for(int i=lIdx; "
