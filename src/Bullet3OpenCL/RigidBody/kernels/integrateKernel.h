...
static const char* integrateKernelCL =
    ...
    "#endif //B3_RIGIDBODY_DATA_H\n"
    "	\n"
    "inline void integrateSingleTransform( __global b3RigidBodyData_t* "
    "bodies,int nodeID, float timeStep, float angularDamping, b3Float4ConstArg "
    "gravityAcceleration)\n"
    "{\n"
    "	\n"
    "	if (bodies[nodeID].m_invMass != 0.f)\n"
    "	{\n"
    "		float BT_GPU_ANGULAR_MOTION_THRESHOLD = (0.25f * "
    "3.14159254f);\n"
    "		//angular velocity\n"
    "		{\n"
    "			b3Float4 axis;\n"
    ...
    "			{\n"
    "				fAngle = BT_GPU_ANGULAR_MOTION_THRESHOLD / "
    "timeStep;\n"
    "			}\n"
    "			if(fAngle < 0.001f)\n"
    "			{\n"
    ...
    "				axis = angvel * "
    "(0.5f*timeStep-(timeStep*timeStep*timeStep)*0.020833333333f * fAngle * "
    "fAngle);\n"
    "			}\n"
    "			else\n"
    "			{\n"
    "				// sync(fAngle) = sin(c*fAngle)/t\n"
    "				axis = angvel * ( b3Sin(0.5f * fAngle * "
    "timeStep) / fAngle);\n"
    "			}\n"
    "			\n"
    "			b3Quat dorn;\n"
    ...
    "	\n"
    "}\n"
    "inline void b3IntegrateTransform( __global b3RigidBodyData_t* body, float "
    "timeStep, float angularDamping, b3Float4ConstArg gravityAcceleration)\n"
    "{\n"
    ...
    "}\n"
    "__kernel void \n"
    "  integrateTransformsKernel( __global b3RigidBodyData_t* bodies,const int "
    "numNodes, float timeStep, float angularDamping, float4 "
    "gravityAcceleration)\n"
    "{\n"
    ...
    "	if( nodeID < numNodes)\n"
    "	{\n"
    "		integrateSingleTransform(bodies,nodeID, timeStep, "
    "angularDamping,gravityAcceleration);\n"
    "	}\n"
    "}\n";
