  ...
  if (useSolver) {
    ...
    if (!gUseLargeBatches) {
...

      {
...

        {
          ...
          // b3OpenCLArrayUtils::map<adl::TYPE_CL, true>( data->m_device, bodyBuf
    ...
    if (gUseLargeBatches) {
      if (nContacts) {
        ...
        //				b3OpenCLArray<unsigned int>* countsNative =
        //m_data->m_solverGPU->m_numConstraints; 				b3OpenCLArray<unsigned int>*
        //offsetsNative = m_data->m_solverGPU->m_offsets;
