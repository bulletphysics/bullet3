...
http://bulletphysics.org Copyright (C) 2006 - 2011 Sony Computer Entertainment
Inc.
...
/// don't really want this code to have to understand GL types. It is a HGLRC in
/// _WIN32 or a GLXContext otherwise.
...
struct b3OpenCLUtils {
  ...
  /// we don't really want this code to have to understand GL types. It is a
  /// HGLRC in _WIN32 or a GLXContext otherwise.
