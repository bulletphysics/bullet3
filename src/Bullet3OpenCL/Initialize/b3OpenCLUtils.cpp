...
int b3OpenCLUtils_clewInit() {
  ...
  const char* cl =
      "/System/Library/Frameworks/OpenCL.framework/Versions/Current/OpenCL";
       ...
       // linux (tested on Ubuntu 12.10 with Catalyst 13.4 beta drivers, not
       // that there is no symbolic link from libOpenCL.so
...
cl_context b3OpenCLUtils_createContextFromPlatform(
   ...
   * whatever the implementation thinks we should be using.
   */
