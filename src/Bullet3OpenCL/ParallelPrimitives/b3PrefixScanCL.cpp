...
#include "b3FillCL.h"
#define B3_PREFIXSCAN_PROG_PATH \
...
b3PrefixScanCL::b3PrefixScanCL(cl_context ctx, cl_device_id device,
...
void b3PrefixScanCL::execute(b3OpenCLArray<unsigned int>& src,
                             b3OpenCLArray<unsigned int>& dst, int n,
                             unsigned int* sum) {
...
void b3PrefixScanCL::executeHost(b3AlignedObjectArray<unsigned int>& src,
                                 b3AlignedObjectArray<unsigned int>& dst, int n,
                                 unsigned int* sum) {
  unsigned int s = 0;
