...
static const char* prefixScanKernelsCL =
    ...
    "__kernel\n"
    "void LocalScanKernel(__global u32* dst, __global u32 *src, __global u32 "
    "*sumBuffer,\n"
    "		uint4 cb)\n"
    "{\n"
    ...
    "0;\n"
    "	u32 sum = ScanExclusive(ldsData, WG_SIZE*2, GET_LOCAL_IDX, "
    "GET_GROUP_SIZE);\n"
    ...
    "__attribute__((reqd_work_group_size(WG_SIZE,1,1)))\n"
    "__kernel\n"
    "void AddOffsetKernel(__global u32 *dst, __global u32 *blockSum, uint4 "
    "cb)\n"
    "{\n"
    ...
    "	}\n"
    "	GROUP_LDS_BARRIER;\n"
    "	u32 sum = ScanExclusive(ldsData, cb.m_numScanBlocks, GET_LOCAL_IDX, "
    "GET_GROUP_SIZE);\n"
