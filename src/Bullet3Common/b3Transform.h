 ...
 *b3Vector3, b3Quaternion and b3Matrix3x3 linear algebra classes. */
B3_ATTRIBUTE_ALIGNED16(class) b3Transform {
 ...
 public:
  ...
  /*		void multInverseLeft(const b3Transform& t1, const b3Transform& t2)
     { b3Vector3 v = t2.m_origin - t1.m_origin; m_basis =
     b3MultTransposeLeft(t1.m_basis, t2.m_basis); m_origin = v * t1.m_basis;
                  }
                  */
