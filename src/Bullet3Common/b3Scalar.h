...
// align those classes on 16-byte boundaries you can manually enable this line or
// set it in the build system for a bit of performance gain (a few percent,
// dependent on usage) #define B3_USE_SSE_IN_API
#endif  // B3_USE_SSE
#include <emmintrin.h>
#endif
#endif
...
// automatically aligned on 16-byte boundaries if apps run into issues, we will
