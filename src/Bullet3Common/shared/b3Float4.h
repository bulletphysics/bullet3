...
inline b3Vector3 b3Normalized(const b3Vector3& vec) { return vec.normalized(); }

inline b3Float4 b3FastNormalized3(b3Float4ConstArg v) { return v.normalized(); }
...
inline int b3MaxDot(b3Float4ConstArg vec, __global const b3Float4* vecArray,
                    int vecLen, float* dotOut) {
