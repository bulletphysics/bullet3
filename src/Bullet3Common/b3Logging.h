...
/// else {...}" would fail You can also customize the message by uncommenting out
...
//} while(0) #define b3Printf b3OutputPrintfVarArgsInternal #define
//b3Printf(...) printf(__VA_ARGS__) #define b3Printf(...)
